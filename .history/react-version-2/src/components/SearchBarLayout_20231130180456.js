...
const SearchBar = ({contextTheme, searchInput, contextThemes, setContextThemes}) => {
  ...
  useEffect(() => {
    // Trigger the useEffect in PexelsApi.jsx when themes change
    setContextThemes(themes); // Assuming you have access to setContextThemes
  }, [themes]);
